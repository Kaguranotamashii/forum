<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<%@ page import="java.util.List,cn.bistu.bbs.entity.ForumEntity"%>
<%@ page import="cn.bistu.bbs.entity.UserEntity" %>
...
<nav class="navbar navbar-inverse" role="navigation"><!-- 顶部的菜单栏 -->
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="forumList">动漫二次元键盘政治爱好者论坛</a>
    </div>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="${pageContext.request.contextPath}/UserInfo?uid=${user.userid}"><span class="glyphicon glyphicon-user"></span> 个人信息</a></li>
      <li><a href="${pageContext.request.contextPath}/UPersonForumList?uid=${user.userid}"><span class="glyphicon glyphicon-user"></span> 我的帖子</a></li>
      <%
        UserEntity admin=(UserEntity)request.getSession().getAttribute("user");
        if(admin.getIs_admin().equals(1)){ %>
...
<div  class="container"><!-- 中间 -->
  <nav class="navbar navbar-default" role="navigation">
    <div>
      ...
      <span style="font-size:24px">欢迎,${user.username}</span>
      ...
      <div class="panel-body">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td><%=forum.getCreate_at()%></td>
            <td><img src=" " class="img-circle">
              <a href="FindUserByIdServlet?uid=<%=forum.getUserid()%>"> <%=forum.getUserid()%> </a></td>
          </tr>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form class="form-horizontal" role="form" name="form1" method="post" action="release">
          ...
          <div class="form-group">
            <%--@declare id="name"--%><label for="name" class="col-sm-2 control-label">内容</label>
            <div class="col-sm-10">
